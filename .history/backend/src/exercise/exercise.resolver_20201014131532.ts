...
export class ExerciseResolver {
  ...
  async create(
    ...
    const path = join(__dirname, '../', '../', 'storage', 'exercises', name, 'JenkinsFile');
     const stream = spawn(`docker run --rm -v ${path}:/workspace/Jenkinsfile jenkins/jenkinsfile-runner "ls ."`) 
